...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_NO   , KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,                                        KC_H     , KC_J     , KC_K     , KC_L     , KC_ESC  , KC_ENT  ,
  ...
  [1] = LAYOUT_universal(
    ...
    _______ ,  KC_LEFT , KC_DOWN , KC_RIGHT , KC_NO , KC_SCOLON ,                                         KC_COLON  , KC_COMMA  , KC_DOT  , KC_SLSH  , KC_MINUS , _______  ,
                  _______  , _______ , _______  ,         _______  , _______  ,                   _______  , _______  , _______       , _______  , _______
  ),

  [2] = LAYOUT_universal(
    _______ , KC_NO         , KC_NO               , KC_NO                , KC_NO , KC_NO ,                                         KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , _______  ,
    _______ , LGUI(KC_UP)   , LGUI(LCTL(KC_LEFT)) , LGUI(LCTL(KC_RIGHT)) , KC_NO , KC_NO ,                                         KC_MS_BTN1  , KC_MS_BTN2  , KC_MHEN, KC_HENK  , KC_NO  , _______  ,
